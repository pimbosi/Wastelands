...
if (instance_exists(obj_torre_1)) && (obj_torre_1.esta_perto == true)  //a vida só aparece se a torre existir e se o jogador estiver perto o suficiente
{
	...
	draw_sprite_ext(spr_torre_life, 0, _gl/2 - _sprl/2 + 6, 100, obj_torre_1.torre_hp/20 * 3 , 3, 0, c_white, 1); //desenha a vida dentro do hud (a divisão é feita pela vida total do boss)
