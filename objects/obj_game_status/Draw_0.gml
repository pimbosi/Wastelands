...
draw_rectangle_color(obj_jogador.x-w_half,obj_jogador.y+h_half,obj_jogador.x-w_half+(xp/ maxXP * 635),obj_jogador.y+h_half- 5,c_aqua,c_aqua,c_aqua,c_aqua,false);
