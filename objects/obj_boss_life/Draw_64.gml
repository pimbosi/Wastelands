...
if instance_exists(obj_boss_2)//a vida só aparece se o boss 2 existir
{
	...
	draw_sprite_ext(spr_boss_life, 0, _gl/2 - _sprl/2 + 6, 100, obj_boss_2.boss_hp/1000 * 3 , 3, 0, c_white, 1); //desenha a vida dentro do hud (a divisão é feita pela vida total do boss)
...
if instance_exists(obj_boss_3) //a vida só aparece se o boss existir
{
	...
	draw_sprite_ext(spr_boss_life, 0, _gl/2 - _sprl/2 + 6, 100, obj_boss_3.boss_hp/2000 * 3 , 3, 0, c_white, 1); //desenha a vida dentro do hud (a divisão é feita pela vida total do boss)
